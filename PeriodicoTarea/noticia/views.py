...
class NoticiaView(ListView):
    model = Noticia
    template_name = 'noticia/ListarNoticias.html'  # Plantilla para mostrar la lista de noticias
...
def agregar_noticia(request):
    if request.method == 'POST':
        ...
        form = NoticiaForm()
    return render(request, 'noticia/AgregarNoticia.html', {'form': form})
...
def editar_noticia(request, id):
    ...
    return render(request, 'noticia/EditarNoticia.html', {'form': form, 'noticia': noticia})
...
def eliminar_noticia(request, id):
    ...
    return render(request, 'noticia/EliminarNoticia.html', {'noticia': noticia})
